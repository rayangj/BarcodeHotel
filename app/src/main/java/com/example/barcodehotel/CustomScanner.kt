...
class CustomScanner constructor(context: Context):
...
//    private val ANIMATION_DELAY = 30L
    ...
    init {
        ...
        setBorderColor(Color.parseColor("#1C9828"))
        setLaserColor(Color.parseColor("#1C9828"))
...
//        var middle = framingRect.height() / 12 + framingRect.top
//        middle += cntr
//
